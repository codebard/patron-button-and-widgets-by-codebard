...
?>
			...
			Yes <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][show_button_under_posts]" value="yes"<?php echo $show_button_under_posts_checked_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][show_button_under_posts]" value="no"<?php echo $show_button_under_posts_checked_no; ?> aria-label="No">
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][append_to_content_order]" value="<?php echo esc_attr($this->opt[$tab]['append_to_content_order']); ?>"  aria-label="Set numeric value for button order of appearance">
			...
			Yes <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][show_message_over_post_button]" value="yes"<?php echo $show_message_over_post_button_checked_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][show_message_over_post_button]" value="no"<?php echo $show_message_over_post_button_checked_no; ?>  aria-label="No">
			
			<h3>Alignment of Message text And Button under Posts</h3>
			You can align the message above the buttons left, center, or right.		
			<br><br>
			Left <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][insert_text_align]" value="left"<?php echo $post_insert_text_align_checked_left; ?>  aria-label="Left">
			Center <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][insert_text_align]" value="center"<?php echo $post_insert_text_align_checked_center; ?>  aria-label="Center">
			Right <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][insert_text_align]" value="right"<?php echo $post_insert_text_align_checked_right; ?>  aria-label="Right">
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][insert_margin]" value="<?php echo esc_attr($this->opt[$tab]['insert_margin']); ?>"  aria-label="Insert numeric margin value">
			...
			<input type="text" style="width : 500px;" name="opt[<?php echo esc_attr($tab); ?>][message_over_post_button]" value="<?php echo esc_attr($this->opt[$tab]['message_over_post_button']); ?>"  aria-label="Type the message to be shown above the post buttons">
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][message_over_post_button_font_size]" value="<?php echo esc_attr($this->opt[$tab]['message_over_post_button_font_size']); ?>"  aria-label="The font size for the message above the buttons">
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][message_over_post_button_margin]" value="<?php echo esc_attr($this->opt[$tab]['message_over_post_button_margin']); ?>"  aria-label="Top and bottom margin for message above the post buttons. Numeric value.">
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][button_margin]" value="<?php echo esc_attr($this->opt[$tab]['button_margin']); ?>"  aria-label="The numeric value for top and bottom margin for buttons">
