...
<h1>Sidebar Widget Styles</h1>
			...
			<br><br>
			Left <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][insert_text_align]" value="left"<?php echo $widget_insert_text_align_checked_left; ?>  aria-label="Left">
			Center <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][insert_text_align]" value="center"<?php echo $widget_insert_text_align_checked_center; ?>  aria-label="Center">
			Right <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][insert_text_align]" value="right"<?php echo $widget_insert_text_align_checked_right; ?>  aria-label="No">
		...
		<h3>Widget Message Font Size</h3>
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][message_font_size]" value="<?php echo esc_attr($this->opt[$tab]['message_font_size']); ?>"   aria-label="The font size for the messages in widgets">
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][message_over_post_button_margin]" value="<?php echo esc_attr($this->opt[$tab]['message_over_post_button_margin']); ?>"  aria-label="The numeric margin for the messages above the widgets.">
			...
			<input type="text" name="opt[<?php echo esc_attr($tab); ?>][button_margin]" value="<?php echo esc_attr($this->opt[$tab]['button_margin']); ?>"  aria-label="The top and bottom margin for the buttons. Numeric.">
			...
			Yes <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][hide_site_widget_on_single_post_page]" value="yes"<?php echo $hide_site_widget_on_single_post_page_checked_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][hide_site_widget_on_single_post_page]" value="no"<?php echo $hide_site_widget_on_single_post_page_checked_no; ?>  aria-label="No">				
