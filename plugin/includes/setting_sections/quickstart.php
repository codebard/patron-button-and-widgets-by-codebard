...
?>
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo $tab; ?>][open_new_window]" value="yes"<?php echo $open_new_window_checked_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo $tab; ?>][open_new_window]" value="no"<?php echo $open_new_window_checked_no; ?>  aria-label="No">
			<br><br>		
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo $tab; ?>][force_site_button]" value="yes"<?php echo $force_site_checked_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo $tab; ?>][force_site_button]" value="no"<?php echo $force_site_checked_no; ?>  aria-label="No">
			<br><br>
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo $tab; ?>][old_button]" value="yes"<?php echo $use_old_patreon_button_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo $tab; ?>][old_button]" value="no"<?php echo $use_old_patreon_button_no; ?>  aria-label="Yes">
			<br><br>
