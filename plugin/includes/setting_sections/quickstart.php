...
?>
			...
			<input type="text" style="width : 500px" name="opt[<?php echo esc_attr($tab); ?>][site_account]" value="<?php echo esc_attr($this->opt[$tab]['site_account']); ?>"  aria-label="The Patreon account to use for the entire site">
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][open_new_window]" value="yes"<?php echo $open_new_window_checked_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][open_new_window]" value="no"<?php echo $open_new_window_checked_no; ?>  aria-label="No">
			<br><br>		
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][force_site_button]" value="yes"<?php echo $force_site_checked_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][force_site_button]" value="no"<?php echo $force_site_checked_no; ?>  aria-label="No">
			<br><br>
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][old_button]" value="yes"<?php echo $use_old_patreon_button_yes; ?>  aria-label="Yes">
			No <input type="radio" name="opt[<?php echo esc_attr($tab); ?>][old_button]" value="no"<?php echo $use_old_patreon_button_no; ?>  aria-label="Yes">
			<br><br>
			...
			<br><br>			
			 <input class="cb_p6_file_upload" type="text" id="opt[<?php echo esc_attr($tab); ?>]_custom_button" size="36" name="opt[<?php echo esc_attr($tab); ?>][custom_button]" value="<?php echo esc_attr($this->opt[$tab]['custom_button']); ?>"   aria-label="Upload the image to use as a custom button" /> <a href="" class="cb_p6_clear_prevfield"   aria-label="Clear">Clear</a>
		<br><br>
		...
		?>
			...
			<br><br>
			<input type="text" style="width : 50px" name="opt[<?php echo esc_attr($tab); ?>][custom_button_width]" value="<?php echo esc_attr($this->opt[$tab]['custom_button_width']); ?>"  aria-label="The numeric value for the width of your custom button image">
